...
def get_client_pubkey(algo):
    ...
    if algo == 'ECDH':
        ...
        pub_bytes, priv_state = ML_KEM_768.keygen()
        return pub_bytes, priv_state
...
def server_encapsulate(algo, client_pub_bytes):
    ...
    if algo == 'ECDH':
        ...
        from kyber_py.ml_kem import ML_KEM_768
        shared_secret, ciphertext = ML_KEM_768.encaps(client_pub_bytes)
        return ciphertext, shared_secret
...
def client_decapsulate(algo, priv_state, ciphertext):
    ...
    if algo == 'ECDH':
        ...
        from kyber_py.ml_kem import ML_KEM_768
        shared_secret = ML_KEM_768.decaps(priv_state, ciphertext)
